...
import { globalContext } from "../myCongtext/MyContext"; // ✅ Ensure folder spelling
...
const Header = () => {
  ...
  const filteredProducts = products.filter(
    (p) => p.title && p.title.toLowerCase().includes(searchText.toLowerCase())
  );
  ...
  return (
    <>
      ...
      <Modal show={showModal} onHide={handleClose} centered size="md">
        ...
        <Modal.Body className="bg-dark text-white px-5">
          {isSignup ? (
            <div ref={signupRef}>
