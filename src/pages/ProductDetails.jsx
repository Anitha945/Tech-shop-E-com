...
const ProductDetails = () => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      avatar:
        "https://ui-avatars.com/api/?name=Ritika+Sen&background=F31260&color=fff",
    },
    {
      id: 3,
      name: "Sangeetha",
          ...
          {activeTab === "overview" && (
            <div>
              ...
              <p>
                ...
                wireless Over-Ear NC Headphones provide fabulous sound quality.
              </p>
              <ul>
                <li>🔊 30 Hours of Playtime with Active Noise Cancelling (ANC)</li>
                <li>🔊 40mm Drivers for Powerful Sound</li>
                <li>🔊 Fast Pairing with Google Fast Pair & Microsoft Swift Pair</li>
                <li>🔊 Hands-Free Voice Control with Alexa & Google Assistant</li>
                <li>🔊 Comfortable Fit with Padded Ear Cups</li>
